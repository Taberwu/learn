 ...
 * @LastEditTime: 2024-07-31 17:42:23
...
public:
    ...
    void collisioncheck(){
        ...
        traj_string1.push_back(rtree::Point(0.0, 0.0));
        traj_string1.push_back(rtree::Point(1.0, 0.0));
        traj_string1.push_back(rtree::Point(2.0, 0.0));
        traj_string1.push_back(rtree::Point(2.38268, 0.07612));
        traj_string1.push_back(rtree::Point(2.5, 0.13397));
        traj_string2.push_back(rtree::Point(2.8660, 0.5));
        traj_string2.push_back(rtree::Point(3.0, 1.0));
        traj_string2.push_back(rtree::Point(3.0, 2.0));
